  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: "space-y-4",
        caption:
          "flex justify-center p-1 relative items-center border-2 border-lightgray rounded-lg mt-2",
        ...
        head_row: "flex gap-[1px]",
        head_cell:
          "text-muted-foreground rounded-md w-9 font-normal text-[0.9rem] border-[1px] rounded-lg bg-lightGray",
